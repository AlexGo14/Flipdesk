...
ALTER TABLE public.agent_id_seq OWNER TO admin;
...
ALTER TABLE public.blacklist_id_seq OWNER TO admin;
...
ALTER TABLE public.customer_datamodel OWNER TO admin;
...
ALTER TABLE public.customer_datamodel_id_seq OWNER TO admin;
...
ALTER TABLE public.customer_datatype OWNER TO admin;
...
ALTER TABLE public.customer_datatype_id_seq OWNER TO admin;
...
ALTER TABLE public.ticket_datamodel OWNER TO admin;
...
ALTER TABLE public.ticket_datamodel_id_seq OWNER TO admin;
...
--
-- Name: Customer_email_key; Type: CONSTRAINT; Schema: public; Owner: admin; Tablespace: 
--
